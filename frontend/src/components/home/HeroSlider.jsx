                ...
                <div className="relative w-full h-full">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-gray-900/80 via-gray-900/40 to-transparent flex items-center">
                    <div className="pl-12 md:pl-24 max-w-xl">
                      ...
                      >
                        <p className="text-primary-light font-semibold uppercase tracking-wider mb-2">
                          {slide.subtitle}
                        </p>
                        <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 leading-tight">
                          {slide.title}
                        </h2>
                        <button className="bg-white text-gray-900 hover:bg-primary hover:text-white px-8 py-3 rounded-full font-medium transition-colors flex items-center gap-2 group">
                          View Collection
