...
const Hero = () => {
  ...
  return (
    <section className="relative -mt-6 pt-30 pb-16 lg:pt-28 lg:pb-18 overflow-hidden bg-[#faf9f8]">
      {/* Container */}
      <div className="container mx-auto px-18">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="max-w-2xl z-10">
            ...
            >
              {/* Tag */}
              <div className="inline-flex items-center gap-2 ml-26 px-4 py-2 rounded-full bg-red-50 text-primary font-medium text-[16px] mb-4 animate-pulse">
                <span className="text-2xl leading-none">✦</span>Premium Furniture Rentals<span className="text-2xl leading-none">✦</span>
              </div>

              {/* Heading */}
              <h1 className="text-5xl lg:text-6xl xl:text-7xl font-black leading-[1.1] tracking-tight text-gray-900 mb-8">
                Rent Premium <br />
                <span className="text-primary">Furniture & <br /> Appliances</span>
              </h1>

              {/* Subtitle */}
              <p className="text-lg text-gray-600 mb-10 leading-relaxed max-w-lg font-medium text-justify">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <button 
                  ...
                  className="flex items-center justify-center gap-2 bg-primary hover:bg-primary-dark text-white px-8 py-4 rounded-full text-lg font-semibold transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
                >
                  Explore Rentals
                ...
                <button 
                  ...
                  className="flex items-center justify-center gap-3 bg-white border border-gray-100 hover:border-gray-200 text-gray-900 px-8 py-4 rounded-full text-lg font-semibold transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 group"
                >
          ...
          >
            ...
            {/* Main Image */}
            <div className="relative z-10 w-[85%] md:w-[75%] mr-8 overflow-hidden rounded-t-[20rem] rounded-b-[6rem]">
            ...
            <motion.div
              ...
              className="absolute bottom-[6%] left-[8%] w-36 md:w-50 rounded-[1.5rem] overflow-hidden shadow-2xl border-[6px] border-white z-20"
            >
              <img
                src={Image3}
                alt="Bedroom"
            ...
            <motion.div
              ...
              className="absolute bottom-[-3%] right-0 w-28 md:w-40 rounded-[1.5rem] overflow-hidden shadow-2xl border-[6px] border-white z-30 translate-x-4"
            >
              <img
                src={Image4}
                alt="Washing Machine"
            ...
            <motion.div
              animate={{ y: [-8, 8, -8] }}
              transition={{ repeat: Infinity, duration: 5, ease: "easeInOut" }}
              className="absolute top-[5%] right-3 w-28 md:w-37 rounded-[1.5rem] overflow-hidden shadow-2xl border-[6px] border-white z-30 translate-x-4"
            >
              <img
                src={Image5}
                alt="Washing Machine"
      ...
      {/* Bottom Features Bar */}
      <div className="container mx-auto px-16 -ml-6 mt-4 relative z-20">
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
